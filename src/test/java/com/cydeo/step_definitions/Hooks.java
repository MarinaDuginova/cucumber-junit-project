...
public class Hooks {
  ...
  //  @Before (value = "@login", order = 2)
    public void setupForLogin(){
        ...
        // you can use value and = "@tagname" to determine this
        System.out.println("It will be closing browser using cucumber " +
  ...
  //  @BeforeStep
    public void setupScenarioSet(){
        System.out.println("Setting up browser using cucumber" +
                "@Before each scenario step");
    }
}
